...
<model ref="r:e295f2ec-c44e-4329-bee0-3c18e08088df(io.lionweb.mps.converter.deps.InterfaceExtends.structure)">
  ...
  <node concept="2DM1_0" id="4Yo3buYmlIy">
    <property role="2DM1AS" value="io-lionweb-mps-converter-deps-InterfaceExtends" />
  </node>
  <node concept="PlHQZ" id="4Yo3buYmoNX">
    <property role="EcuMT" value="5735348108768414973" />
    <property role="TrG5h" value="InterfaceExtends" />
    <node concept="PrWs8" id="4Yo3buYmoS7" role="PrDN$">
      <ref role="PrY4T" to="fbi0:4Yo3buYmkV0" resolve="OnlyBuiltinsContent" />
    </node>
    <node concept="2DM1AW" id="4Yo3buYmoWi" role="lGtFl">
      <property role="2DM1AS" value="InterfaceExtends" />
    </node>
  </node>
</model>
