...
<model ref="r:64c17be0-612c-4db6-9d04-1746e2ecf3cc(io.lionweb.mps.converter.deps.ConceptExtends.structure)">
  ...
  <node concept="2DM1_0" id="4Yo3buYmlIy">
    <property role="2DM1AS" value="io-lionweb-mps-converter-deps-ConceptExtends" />
  </node>
  <node concept="1TIwiD" id="4Yo3buYmoqf">
    <property role="EcuMT" value="5735348108768413327" />
    <property role="TrG5h" value="ConceptExtends" />
    <ref role="1TJDcQ" to="nfly:4Yo3buYlCuh" resolve="StandaloneContent" />
    <node concept="2DM1AW" id="4Yo3buYmoxJ" role="lGtFl">
      <property role="2DM1AS" value="ConceptExtends" />
    </node>
  </node>
</model>
