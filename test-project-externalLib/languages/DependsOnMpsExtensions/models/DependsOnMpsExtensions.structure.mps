...
<model ref="r:e52b8b75-35b6-4648-b807-f16807d24461(DependsOnMpsExtensions.structure)">
  ...
  <node concept="1TIwiD" id="1C4OO_mGoAd">
    <property role="EcuMT" value="1874855656833517965" />
    <property role="TrG5h" value="SomethingDifferent" />
    <property role="19KtqR" value="true" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="PrWs8" id="1C4OO_mGoAf" role="PzmwI">
      <ref role="PrY4T" to="87nw:2dWzqxEBBFG" resolve="IWord" />
    </node>
  </node>
  <node concept="2DM1_0" id="1C4OO_mGoAe">
    <property role="2DM1AS" value="DependsOnMpsExtensions-lang" />
  </node>
</model>
